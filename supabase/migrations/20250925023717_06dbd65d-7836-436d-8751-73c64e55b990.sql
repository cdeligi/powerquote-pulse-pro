-- Update generate_quote_id function to include email prefix
CREATE OR REPLACE FUNCTION public.generate_quote_id(user_email text DEFAULT NULL::text, is_draft boolean DEFAULT false)
RETURNS text
LANGUAGE plpgsql
SECURITY DEFINER
AS $function$
