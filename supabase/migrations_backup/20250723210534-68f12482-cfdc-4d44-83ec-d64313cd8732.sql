...
-- Fixed migration with proper PostgreSQL syntax
...
-- 5. Clear existing data and insert fresh Level 1 products with rack_configurable settings
...
-- 9. Update RLS policies to work with new schema
