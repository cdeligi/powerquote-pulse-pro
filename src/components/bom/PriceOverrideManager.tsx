...
const PriceOverrideManager = ({
  ...
  return (
    <div className="space-y-4 bg-gray-800 p-4 rounded-lg">
      <h4 className="text-white font-medium">Edit Item Price</h4>
      ...
      {/* Permission Summary */}
      <div className="text-xs text-gray-400 space-y-1 bg-gray-700 rounded p-2">
      ...
      <div className="flex space-x-2">
        <Button
          ...
          disabled={!canMakeChange() || !reason.trim() || disabled}
