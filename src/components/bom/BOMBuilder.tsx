  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      const level1Data: Level1Product[] = [
        { id: '1', name: 'QTMS', type: 'QTMS', description: 'Qualitrol Transformer Monitoring System', price: 12000, enabled: true, productInfoUrl: 'https://www.qualitrolcorp.com/products/qualitrol-qtms-transformer-monitoring-system/', image: '/qtms.webp', hasQuantitySelection: true, partNumber: undefined },
        { id: '2', name: 'TM8', type: 'TM8', description: 'Transformer Monitor TM8', price: 8000, enabled: true, productInfoUrl: 'https://www.qualitrolcorp.com/products/qualitrol-tm8-transformer-monitor/', image: '/tm8.webp', partNumber: undefined },
        { id: '3', name: 'TM3', type: 'TM3', description: 'Transformer Monitor TM3', price: 5000, enabled: true, productInfoUrl: 'https://www.qualitrolcorp.com/products/qualitrol-tm3-transformer-monitor/', image: '/tm3.webp', partNumber: undefined },
        { id: '4', name: 'TM1', type: 'TM1', description: 'Transformer Monitor TM1', price: 3000, enabled: true, productInfoUrl: 'https://www.qualitrolcorp.com/products/qualitrol-tm1-transformer-monitor/', image: '/tm1.webp', customizations: ['Moisture Sensor', '4-20mA bridge'], partNumber: undefined },
        { id: '5', name: 'QPDM', type: 'QPDM', description: 'Qualitrol Partial Discharge Monitor', price: 15000, enabled: true, productInfoUrl: 'https://www.qualitrolcorp.com/products/qualitrol-qpdm-partial-discharge-monitor/', image: '/qpdm.webp', partNumber: undefined },
      ];
      const chassisData: Chassis[] = [
        { id: '101', name: 'LTX-14', type: 'LTX', height: '3U', slots: 14, price: 2500, description: '19" Rack Mount, 3U high, 14 slots (7 front / 7 rear)', image: '/ltx-14.webp', partNumber: 'LTX-14-001', hasQuantitySelection: undefined },
        { id: '102', name: 'MTX-8', type: 'MTX', height: '2U', slots: 8, price: 1800, description: '19" Rack Mount, 2U high, 8 slots', image: '/mtx-8.webp', partNumber: 'MTX-8-002', hasQuantitySelection: undefined },
        { id: '103', name: 'STX-4', type: 'STX', height: '1U', slots: 4, price: 1200, description: '19" Rack Mount, 1U high, 4 slots', image: '/stx-4.webp', partNumber: 'STX-4-003', hasQuantitySelection: undefined },
      ];
      const cardData: Card[] = [
        { id: '201', name: 'Relay Card', type: 'relay', description: '8-Channel Relay Card', price: 450, slotRequirement: 1, compatibleChassis: ['101', '102', '103'], specifications: { channels: 8, voltage: '24VDC', current: '2A' }, image: '/relay-card.webp', partNumber: 'RELAY-8-001', hasQuantitySelection: false, enabled: true },
        { id: '202', name: 'Analog Input Card', type: 'analog', description: '4-Channel Analog Input Card', price: 600, slotRequirement: 1, compatibleChassis: ['101', '102', '103'], specifications: { channels: 4, inputRange: '0-10V', resolution: '16-bit' }, image: '/analog-input-card.webp', partNumber: 'ANALOG-4-002', hasQuantitySelection: false, enabled: true },
        { id: '203', name: 'Fiber Optic Card', type: 'fiber', description: '2-Channel Fiber Optic Communication Card', price: 800, slotRequirement: 1, compatibleChassis: ['101', '102'], specifications: { channels: 2, protocol: 'Modbus TCP', wavelength: '1310nm' }, image: '/fiber-optic-card.webp', partNumber: 'FIBER-2-003', hasQuantitySelection: false, enabled: true },
        { id: '204', name: 'Display Card', type: 'display', description: 'LCD Display Card', price: 500, slotRequirement: 1, compatibleChassis: ['101', '102', '103'], specifications: { displayType: 'LCD', resolution: '128x64', interface: 'Serial' }, image: '/display-card.webp', partNumber: 'DISPLAY-LCD-004', hasQuantitySelection: false, enabled: true },
        { id: '205', name: 'Bushing Sensor Card', type: 'bushing', description: 'Bushing Sensor Interface Card', price: 700, slotRequirement: 1, compatibleChassis: ['101', '102'], specifications: { sensorType: 'DGA', channels: 6, accuracy: '±1%' }, image: '/bushing-sensor-card.webp', partNumber: 'BUSHING-DGA-005', hasQuantitySelection: false, enabled: true },
      ];
