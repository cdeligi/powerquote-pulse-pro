...
const BOMBuilder = ({ user }: BOMBuilderProps) => {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      ...
      const cardData: Card[] = [
        { id: '201', name: 'Relay Card', type: 'relay', description: '8-Channel Relay Card', price: 450, slotRequirement: 1, compatibleChassis: ['101', '102', '103'], specifications: { channels: 8, voltage: '24VDC', current: '2A' }, image: '/relay-card.webp', partNumber: 'RELAY-8-001' },
        { id: '202', name: 'Analog Input Card', type: 'analog', description: '4-Channel Analog Input Card', price: 600, slotRequirement: 1, compatibleChassis: ['101', '102', '103'], specifications: { channels: 4, inputRange: '0-10V', resolution: '16-bit' }, image: '/analog-input-card.webp', partNumber: 'ANALOG-4-002' },
        { id: '203', name: 'Fiber Optic Card', type: 'fiber', description: '2-Channel Fiber Optic Communication Card', price: 800, slotRequirement: 1, compatibleChassis: ['101', '102'], specifications: { channels: 2, protocol: 'Modbus TCP', wavelength: '1310nm' }, image: '/fiber-optic-card.webp', partNumber: 'FIBER-2-003' },
        { id: '204', name: 'Display Card', type: 'display', description: 'LCD Display Card', price: 500, slotRequirement: 1, compatibleChassis: ['101', '102', '103'], specifications: { displayType: 'LCD', resolution: '128x64', interface: 'Serial' }, image: '/display-card.webp', partNumber: 'DISPLAY-LCD-004' },
        { id: '205', name: 'Bushing Sensor Card', type: 'bushing', description: 'Bushing Sensor Interface Card', price: 700, slotRequirement: 1, compatibleChassis: ['101', '102'], specifications: { sensorType: 'DGA', channels: 6, accuracy: '±1%' }, image: '/bushing-sensor-card.webp', partNumber: 'BUSHING-DGA-005' },
      ];
