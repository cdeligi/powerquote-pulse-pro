...
export const Level4ConfigurationManager: React.FC = () => {
  ...
  const loadData = () => {
    try {
      setIsLoading(true);
      console.log('Loading Level 4 configuration data...');
      
      const l4Products = productDataService.getLevel4Products();
      const l3Products = productDataService.getLevel3Products();
      
      console.log('Loaded Level 4 data:', { l4Count: l4Products.length, l3Count: l3Products.length });
      
      setLevel4Products(l4Products);
      setLevel3Products(l3Products);
    } catch (error) {
      console.error('Error loading Level 4 configuration data:', error);
      toast({
        title: "Error",
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button 
          ...
          disabled={level3Products.length === 0}
        >
