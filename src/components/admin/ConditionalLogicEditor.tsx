...
const ConditionalLogicEditor = ({ rules, onChange, parentFieldLabel }: ConditionalLogicEditorProps) => {
  ...
  if (!rules.length) {
    return (
      <div className="border border-dashed border-gray-700 rounded-md p-4 text-sm text-gray-400 bg-gray-900/40">
        ...
        <Button type="button" variant="outline" size="sm" className="mt-3 border-gray-700 text-gray-200 hover:text-white" onClick={handleAddRule}>
  ...
  return (
    <div className="space-y-4">
        ...
        <Card key={rule.id} className="bg-gray-900 border-gray-800">
            <CardHeader className="pb-3">
              <CardTitle className="flex items-center justify-between text-white text-sm">
                ...
                <Button type="button" variant="ghost" size="sm" className="text-red-400 hover:text-red-300" onClick={() => handleRemoveRule(index)}>
            ...
            <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => handleRuleChange(index, { ...rule, displayMode: value as QuoteFieldConditionalRule['displayMode'] })}
                    >
                      <SelectTrigger className="bg-gray-800 border-gray-700 text-white">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent className="bg-gray-800 border-gray-700">
                        <SelectItem value="inline" className="text-white">Inline</SelectItem>
                        <SelectItem value="modal" className="text-white">Modal</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Button type="button" size="sm" className="bg-red-600 hover:bg-red-700" onClick={() => handleAddField(index)}>
                        ...
                        <CardContent className="pt-4 space-y-3">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <div>
                              ...
                              <Input
                                value={field.id}
                                onChange={(event) => handleFieldChange(ruleIndex, fieldIndex, {
                                  ...field,
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div>
                              ...
                              <Select
                                value={field.type}
                                onValueChange={(value) => handleFieldChange(ruleIndex, fieldIndex, {
                                  ...field,
                            ...
                            <div className="flex items-center gap-2">
                              <Switch
                                ...
                                onCheckedChange={(checked) => handleFieldChange(ruleIndex, fieldIndex, {
                                  ...field,
                                  required: checked,
                                })}
      ...
      <Button type="button" variant="outline" size="sm" className="border-gray-700 text-gray-200 hover:text-white" onClick={handleAddRule}>
