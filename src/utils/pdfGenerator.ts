  ...
  const htmlContent = `
    ...
    <head>
      ...
      <style>
        ...
        .header { border-bottom: 2px solid #dc2626; padding-bottom: 20px; margin-bottom: 30px; display: flex; align-items: center; justify-content: space-between; }
        .logo-section { display: flex; align-items: center; }
        .logo { height: 60px; width: auto; margin-right: 20px; }
        .header-text { flex: 1; }
        .quote-title { font-size: 24px; font-weight: bold; margin: 0; }
        ...
        .part-number { font-family: monospace; color: #666; font-size: 11px; }
    ...
    <body>
      <div class="header">
        <div class="logo-section">
          <img src="/lovable-uploads/b13a93dd-cdec-4101-8ddf-a5404f709718.png" alt="Qualitrol Logo" class="logo">
          <div class="header-text">
            <h1 class="quote-title">Quote Draft</h1>
          ...
          ${bomItems
            ...
            .map(item => `
              <tr>
                <td>
                  ${item.product.name}
                  ${item.partNumber ? `<br><span class="part-number">PN: ${item.partNumber}</span>` : ''}
                </td>
                <td>${item.product.description}</td>
                <td class="part-number">${item.partNumber || 'TBD'}</td>
                <td>${item.quantity}</td>
                <td>${item.slot || 'N/A'}</td>
                ${canSeePrices ? `
      ...
      <div class="footer">
        ...
        <p>Generated by Qualitrol PowerQuotePro System</p>
      </div>
    </body>
    </html>
  `;
