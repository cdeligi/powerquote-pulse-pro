...
export const generateQuotePDF = (
  ...
  // Get quote validity from admin settings (default 30 days)
  const adminSettings = localStorage.getItem('adminSettings');
  const validityDays = adminSettings ? JSON.parse(adminSettings).quoteValidityDays || 30 : 30;
  ...
  const htmlContent = `
    ...
    <head>
      ...
      <style>
        ...
        .validity { background: #fef3c7; border: 1px solid #f59e0b; padding: 10px; border-radius: 5px; margin: 10px 0; }
        .validity-text { color: #92400e; font-weight: bold; }
    ...
    <body>
      <div class="header">
        ...
        <div class="validity">
          <div class="validity-text">Valid Until: ${validUntilDate.toLocaleDateString()}</div>
        </div>
      </div>
      ...
      <div class="footer">
        ...
        <p>Quote valid for ${validityDays} days from generation date.</p>
